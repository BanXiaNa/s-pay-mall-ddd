...
import com.banxia.api.IPayService;
...
public class PayServiceImpl implements IPayService {
    ...
    public Response<String> createPayOrder(@RequestBody CreatePayRequestDTO createPayRequestDTO) {
        try {
            ...
            System.out.println(createPayRequestDTO.getUserId());
            System.out.println(createPayRequestDTO.getProductId());


            PayOrderEntity payOrderRes = orderService.createOrder(ShopCartEntity.builder()
                    .userId(createPayRequestDTO.getUserId())
                    .productId(createPayRequestDTO.getProductId())
                    .build());

            log.info("商品下单，根据商品ID创建支付单完成 userId:{} productId:{} orderId:{}", createPayRequestDTO.getUserId(), createPayRequestDTO.getProductId(), payOrderRes.getOrderId());
